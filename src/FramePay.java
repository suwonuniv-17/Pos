...
public class FramePay extends JFrame {
   ...
   public void inputTable() {
      ...
      int table_num = tablelist.get(0).getalone() + tablelist.get(0).gettwo() + tablelist.get(0).getfour() + tablelist.get(0).getmany();
      JButton [] mbtn= new JButton[table_num];
      ...
      if(table_num >16) {
         for(int i = 0 ; i <table_num ; i++) {
            ...
            mbtn[i] = new JButton(str[i]);
            mbtn[i].setPreferredSize(new Dimension(76,b));
            mbtn[i].setBorder(b2);
         ...
         for(int i = 0 ; i <table_num ; i++) {
            ...
            mbtn[i] = new JButton(str[i]);
            mbtn[i].setPreferredSize(new Dimension(76,80));
            mbtn[i].setBorder(b2);
            mbtn[i].setBackground(new Color(240,240,240));
            mbtn[i].setFont(new Font("한컴 고딕",Font.BOLD, 10));
            tablePanel.add(mbtn[i]);
